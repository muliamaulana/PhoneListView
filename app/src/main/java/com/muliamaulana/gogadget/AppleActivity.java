...
public class AppleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new AppleActivity.JSONAsyncTask().execute("http://ibacor.com/api/gsm-arena?view=brand&slug=apple&page=1");

        ListView listview = (ListView) findViewById(R.id.myListView);
        phoneAdapter = new PhoneAdapter(AppleActivity.this, R.layout.list_item_hp, phoneList);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent detailPhone = new Intent(AppleActivity.this, DetailPhone.class);
    ...
    class JSONAsyncTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(AppleActivity.this);
...
//            dialog.setTitle("Connecting server");
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result == false)
                Toast.makeText(AppleActivity.this, "Unable to fetch data from server", Toast.LENGTH_LONG).show();
